...
MIGRATION_MODULES = {"sites": "be_logbook.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "be_logbook.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = ['"Shreyas More" <shreyasvmore34@gmail.com>']
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "be_logbook.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "be_logbook.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "be_logbook.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "be_logbook.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "BE Logbook API",
    "DESCRIPTION": "Documentation of API endpoints of BE Logbook",
    "VERSION": "1.0.0",
